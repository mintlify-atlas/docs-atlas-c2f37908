...
```bash
xenia.exe --trace_gpu_prefix=path/file_prefix_ game.xex
```
...
```bash
xenia.exe --trace_gpu_prefix=traces/frame_ game.xex
```
...
```bash
xenia.exe --trace_gpu_prefix=traces/stream_ --trace_gpu_stream game.xex
```
...
```bash
# Initial capture
xenia.exe --trace_gpu_prefix=debug/issue_ game.xex
